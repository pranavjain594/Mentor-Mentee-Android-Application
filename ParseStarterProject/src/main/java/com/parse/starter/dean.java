...
public class dean extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        query.whereEqualTo("dean","acceptedbymentor");
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                if (e == null) {
                    ...
                    Toast.makeText(dean.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        ...
        mlv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent=new Intent(getApplicationContext(),leaverequesttodean.class);

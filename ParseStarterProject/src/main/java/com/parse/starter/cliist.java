...
public class cliist extends AppCompatActivity {
    ListView mlv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cliist);
                ...
                if (e == null) {
                    if (objects.size() > 0) {
                        ...
                        for (ParseObject request : objects) {
                            ...
                            String r = request.getString("subject")+"\n"+df.format(date);
                    ...
                    Toast.makeText(cliist.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
